...
export default function UpdateDescription() {
  ...
  useEffect(() => {
    ...
    if (progress["whatsNewConditions"]) {
      progress["whatsNewConditions"][0] = false;
    } else {
      progress["whatsNewConditions"] = [false];
    }
  ...
  const isOpenToggle = () => {
    ...
    if (progress["whatsNewConditions"]) {
      progress["whatsNewConditions"][0] = true;
    } else {
      progress["whatsNewConditions"] = [true];
    }
    setProgress(progress);
  };
